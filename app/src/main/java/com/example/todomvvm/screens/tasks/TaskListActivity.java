...
import com.example.todomvvm.screens.tasks.viewmodel.DeleteViewModel;
...
public class TaskListActivity extends AppCompatActivity implements TaskAdapter.ItemClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.about:
                Toast.makeText(getApplicationContext(), "Todo helps to organize tasks and activities according to scheduled date.",
                        Toast.LENGTH_SHORT).show();

            case R.id.githubLink:
                Intent implicitIntent= new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/nikitash11"));
